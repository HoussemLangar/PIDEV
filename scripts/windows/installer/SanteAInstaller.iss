...
UninstallDisplayIcon={app}\SanteA Launcher.cmd
...
[Icons]
Name: "{autodesktop}\SanteA Desktop"; Filename: "{app}\SanteA Launcher.cmd"; WorkingDir: "{app}"
Name: "{autoprograms}\SanteA Desktop"; Filename: "{app}\SanteA Launcher.cmd"; WorkingDir: "{app}"
