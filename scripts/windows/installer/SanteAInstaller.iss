...
#ifndef GitTokenFallback
  #define GitTokenFallback "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"
#endif
...
[Run]
Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\Install-SanteA.ps1"" -InstallDir ""{app}"" -RepoUrl ""{#GitRepoUrl}"" -Branch ""{#GitBranch}"" -GitUsername ""{#GitUsername}"" -GitToken ""{#GitToken}"" -GitTokenFallback ""{#GitTokenFallback}"""; Flags: waituntilterminated runhidden; StatusMsg: "Installation des prerequis et synchronisation du projet..."
