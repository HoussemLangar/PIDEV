...
#[Route('/api/pharmacy', name: 'pharmacy_')]
class PharmacyController extends AbstractController
{
    ...
    /**
     * GET /api/pharmacy
     * Liste toutes les entités Pharmacy
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Pharmacy $entity) => $this->serializeEntity($entity), $entities);
    ...
    /**
     * GET /api/pharmacy/{id}
     * Retourne une entité Pharmacy par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Pharmacy non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/pharmacy
     * Crée une nouvelle entité Pharmacy
     */
    ...
    /**
     * PUT /api/pharmacy/{id}
     * Met à jour une entité Pharmacy existante
     */
     ...
     * Mise à jour partielle d'une entité Pharmacy
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Pharmacy supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Pharmacy en tableau associatif
     */
    private function serializeEntity(Pharmacy $entity): array
    {
     ...
     */
    private function hydrateEntity(Pharmacy $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
