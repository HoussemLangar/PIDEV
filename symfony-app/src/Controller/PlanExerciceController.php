...
#[Route('/api/plan-exercice', name: 'plan-exercice_')]
class PlanExerciceController extends AbstractController
{
    public function __construct(
        private readonly PlanExerciceRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/plan-exercice
     * Liste toutes les entités PlanExercice
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(PlanExercice $entity) => $this->serializeEntity($entity), $entities);

        return new JsonResponse($data);
    }

    /**
     * GET /api/plan-exercice/{id}
     * Retourne une entité PlanExercice par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'PlanExercice non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/plan-exercice
     * Crée une nouvelle entité PlanExercice
     */
    ...
    /**
     * PUT /api/plan-exercice/{id}
     * Met à jour une entité PlanExercice existante
     */
    ...
    /**
     * PATCH /api/plan-exercice/{id}
     * Mise à jour partielle d'une entité PlanExercice
     */
    ...
    /**
     * DELETE /api/plan-exercice/{id}
     * Supprime une entité PlanExercice
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'PlanExercice supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité PlanExercice en tableau associatif
     */
    private function serializeEntity(PlanExercice $entity): array
    {
     ...
     */
    private function hydrateEntity(PlanExercice $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
