...
class SymptomeQuotidienController extends AbstractController
{
    ...
    public function webInterface(Request $request, EntityManagerInterface $em, PatientRepository $patientRepository, SymptomeQuotidienRepository $symptomeRepository, SymptomeListeRepository $symptomeListeRepository): Response
    {
