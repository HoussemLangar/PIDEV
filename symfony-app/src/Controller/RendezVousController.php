...
#[Route('/api/rendez-vous', name: 'rendez-vous_')]
class RendezVousController extends AbstractController
{
    ...
    /**
     * GET /api/rendez-vous
     * Liste toutes les entités RendezVous
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(RendezVous $entity) => $this->serializeEntity($entity), $entities);
     ...
     * Retourne une entité RendezVous par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'RendezVous non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
     ...
     * Crée une nouvelle entité RendezVous
     */
     ...
     * Met à jour une entité RendezVous existante
     */
     ...
     * Mise à jour partielle d'une entité RendezVous
     */
     ...
     * Supprime une entité RendezVous
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'RendezVous supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité RendezVous en tableau associatif
     */
    private function serializeEntity(RendezVous $entity): array
    {
     ...
     */
    private function hydrateEntity(RendezVous $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
