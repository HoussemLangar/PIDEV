...
#[Route('/api/reponse-medecin', name: 'reponse-medecin_')]
class ReponseMedecinController extends AbstractController
{
    public function __construct(
        private readonly ReponseMedecinRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/reponse-medecin
     * Liste toutes les entités ReponseMedecin
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(ReponseMedecin $entity) => $this->serializeEntity($entity), $entities);

        return new JsonResponse($data);
    }

    /**
     * GET /api/reponse-medecin/{id}
     * Retourne une entité ReponseMedecin par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'ReponseMedecin non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/reponse-medecin
     * Crée une nouvelle entité ReponseMedecin
     */
    ...
    /**
     * PUT /api/reponse-medecin/{id}
     * Met à jour une entité ReponseMedecin existante
     */
    ...
    /**
     * PATCH /api/reponse-medecin/{id}
     * Mise à jour partielle d'une entité ReponseMedecin
     */
    ...
    /**
     * DELETE /api/reponse-medecin/{id}
     * Supprime une entité ReponseMedecin
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'ReponseMedecin supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité ReponseMedecin en tableau associatif
     */
    private function serializeEntity(ReponseMedecin $entity): array
    {
     ...
     */
    private function hydrateEntity(ReponseMedecin $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
