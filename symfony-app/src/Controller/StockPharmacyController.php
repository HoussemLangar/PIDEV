...
#[Route('/api/stock-pharmacy', name: 'stock-pharmacy_')]
class StockPharmacyController extends AbstractController
{
    public function __construct(
        private readonly StockPharmacyRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/stock-pharmacy
     * Liste toutes les entités StockPharmacy
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(StockPharmacy $entity) => $this->serializeEntity($entity), $entities);

        return new JsonResponse($data);
    }

    /**
     * GET /api/stock-pharmacy/{id}
     * Retourne une entité StockPharmacy par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'StockPharmacy non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/stock-pharmacy
     * Crée une nouvelle entité StockPharmacy
     */
    ...
    /**
     * PUT /api/stock-pharmacy/{id}
     * Met à jour une entité StockPharmacy existante
     */
    ...
    /**
     * PATCH /api/stock-pharmacy/{id}
     * Mise à jour partielle d'une entité StockPharmacy
     */
    ...
    /**
     * DELETE /api/stock-pharmacy/{id}
     * Supprime une entité StockPharmacy
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'StockPharmacy supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité StockPharmacy en tableau associatif
     */
    private function serializeEntity(StockPharmacy $entity): array
    {
     ...
     */
    private function hydrateEntity(StockPharmacy $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
