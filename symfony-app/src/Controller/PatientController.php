...
#[Route('/api/patient', name: 'patient_')]
class PatientController extends AbstractController
{
    ...
    /**
     * GET /api/patient
     * Liste toutes les entités Patient
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Patient $entity) => $this->serializeEntity($entity), $entities);
    ...
    /**
     * GET /api/patient/{id}
     * Retourne une entité Patient par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Patient non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/patient
     * Crée une nouvelle entité Patient
     */
    ...
    /**
     * PUT /api/patient/{id}
     * Met à jour une entité Patient existante
     */
     ...
     * Mise à jour partielle d'une entité Patient
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Patient supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Patient en tableau associatif
     */
    private function serializeEntity(Patient $entity): array
    {
     ...
     */
    private function hydrateEntity(Patient $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
