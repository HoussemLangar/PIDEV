...
#[Route('/api/clinique', name: 'clinique_')]
class CliniqueController extends AbstractController
{
    public function __construct(
        private readonly CliniqueRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/clinique
     * Liste toutes les entités Clinique
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Clinique $entity) => $this->serializeEntity($entity), $entities);
    ...
    /**
     * GET /api/clinique/{id}
     * Retourne une entité Clinique par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Clinique non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/clinique
     * Crée une nouvelle entité Clinique
     */
    ...
    /**
     * PUT /api/clinique/{id}
     * Met à jour une entité Clinique existante
     */
    ...
    /**
     * PATCH /api/clinique/{id}
     * Mise à jour partielle d'une entité Clinique
     */
    ...
    /**
     * DELETE /api/clinique/{id}
     * Supprime une entité Clinique
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Clinique supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Clinique en tableau associatif
     */
    private function serializeEntity(Clinique $entity): array
    {
     ...
     */
    private function hydrateEntity(Clinique $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
