...
#[Route('/api/medicament', name: 'medicament_')]
class MedicamentController extends AbstractController
{
    ...
    /**
     * GET /api/medicament
     * Liste toutes les entités Medicament
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Medicament $entity) => $this->serializeEntity($entity), $entities);
     ...
     * Retourne une entité Medicament par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Medicament non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/medicament
     * Crée une nouvelle entité Medicament
     */
     ...
     * Met à jour une entité Medicament existante
     */
    ...
    /**
     * PATCH /api/medicament/{id}
     * Mise à jour partielle d'une entité Medicament
     */
     ...
     * Supprime une entité Medicament
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Medicament supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Medicament en tableau associatif
     */
    private function serializeEntity(Medicament $entity): array
    {
     ...
     */
    private function hydrateEntity(Medicament $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
