...
#[Route('/api/reponse-medicament', name: 'reponse-medicament_')]
class ReponseMedicamentController extends AbstractController
{
    public function __construct(
        private readonly ReponseMedicamentRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/reponse-medicament
     * Liste toutes les entités ReponseMedicament
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(ReponseMedicament $entity) => $this->serializeEntity($entity), $entities);

        return new JsonResponse($data);
    }

    /**
     * GET /api/reponse-medicament/{id}
     * Retourne une entité ReponseMedicament par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'ReponseMedicament non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/reponse-medicament
     * Crée une nouvelle entité ReponseMedicament
     */
    ...
    /**
     * PUT /api/reponse-medicament/{id}
     * Met à jour une entité ReponseMedicament existante
     */
    ...
    /**
     * PATCH /api/reponse-medicament/{id}
     * Mise à jour partielle d'une entité ReponseMedicament
     */
    ...
    /**
     * DELETE /api/reponse-medicament/{id}
     * Supprime une entité ReponseMedicament
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'ReponseMedicament supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité ReponseMedicament en tableau associatif
     */
    private function serializeEntity(ReponseMedicament $entity): array
    {
     ...
     */
    private function hydrateEntity(ReponseMedicament $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
