...
#[Route('/api/accompagnement', name: 'accompagnement_')]
class AccompagnementController extends AbstractController
{
    public function __construct(
        private readonly AccompagnementRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/accompagnement
     * Liste toutes les entités Accompagnement
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Accompagnement $entity) => $this->serializeEntity($entity), $entities);
     ...
     * Retourne une entité Accompagnement par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Accompagnement non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
     ...
     * Crée une nouvelle entité Accompagnement
     */
     ...
     * Met à jour une entité Accompagnement existante
     */
    ...
    /**
     * PATCH /api/accompagnement/{id}
     * Mise à jour partielle d'une entité Accompagnement
     */
    ...
    /**
     * DELETE /api/accompagnement/{id}
     * Supprime une entité Accompagnement
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Accompagnement supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Accompagnement en tableau associatif
     */
    private function serializeEntity(Accompagnement $entity): array
    {
     ...
     */
    private function hydrateEntity(Accompagnement $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
