...
class LikeController extends AbstractController
{
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Like $entity) => $this->serializeEntity($entity), $entities);
    ...
    /**
     * GET /api/like/{id}
     * Retourne une entité Like par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Like non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * PUT /api/like/{id}
     * Met à jour une entité Like existante
     */
    ...
    /**
     * PATCH /api/like/{id}
     * Mise à jour partielle d'une entité Like
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Like supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Like en tableau associatif
     */
    private function serializeEntity(Like $entity): array
    {
     ...
     */
    private function hydrateEntity(Like $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
