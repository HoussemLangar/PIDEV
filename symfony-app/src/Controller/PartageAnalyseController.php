...
#[Route('/api/partage-analyse', name: 'partage-analyse_')]
class PartageAnalyseController extends AbstractController
{
    public function __construct(
        private readonly PartageAnalyseRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/partage-analyse
     * Liste toutes les entités PartageAnalyse
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(PartageAnalyse $entity) => $this->serializeEntity($entity), $entities);

        return new JsonResponse($data);
    }

    /**
     * GET /api/partage-analyse/{id}
     * Retourne une entité PartageAnalyse par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'PartageAnalyse non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/partage-analyse
     * Crée une nouvelle entité PartageAnalyse
     */
    ...
    /**
     * PUT /api/partage-analyse/{id}
     * Met à jour une entité PartageAnalyse existante
     */
    ...
    /**
     * PATCH /api/partage-analyse/{id}
     * Mise à jour partielle d'une entité PartageAnalyse
     */
    ...
    /**
     * DELETE /api/partage-analyse/{id}
     * Supprime une entité PartageAnalyse
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'PartageAnalyse supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité PartageAnalyse en tableau associatif
     */
    private function serializeEntity(PartageAnalyse $entity): array
    {
     ...
     */
    private function hydrateEntity(PartageAnalyse $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
