...
#[Route('/api/journal-item', name: 'journal-item_')]
class JournalItemController extends AbstractController
{
    public function __construct(
        private readonly JournalItemRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/journal-item
     * Liste toutes les entités JournalItem
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(JournalItem $entity) => $this->serializeEntity($entity), $entities);

        return new JsonResponse($data);
    }

    /**
     * GET /api/journal-item/{id}
     * Retourne une entité JournalItem par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'JournalItem non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/journal-item
     * Crée une nouvelle entité JournalItem
     */
    ...
    /**
     * PUT /api/journal-item/{id}
     * Met à jour une entité JournalItem existante
     */
    ...
    /**
     * PATCH /api/journal-item/{id}
     * Mise à jour partielle d'une entité JournalItem
     */
    ...
    /**
     * DELETE /api/journal-item/{id}
     * Supprime une entité JournalItem
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'JournalItem supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité JournalItem en tableau associatif
     */
    private function serializeEntity(JournalItem $entity): array
    {
     ...
     */
    private function hydrateEntity(JournalItem $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
