...
#[Route('/api/nutritionniste', name: 'nutritionniste_')]
class NutritionnisteController extends AbstractController
{
    public function __construct(
        private readonly NutritionnisteRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/nutritionniste
     * Liste toutes les entités Nutritionniste
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Nutritionniste $entity) => $this->serializeEntity($entity), $entities);

        return new JsonResponse($data);
    }

    /**
     * GET /api/nutritionniste/{id}
     * Retourne une entité Nutritionniste par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Nutritionniste non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/nutritionniste
     * Crée une nouvelle entité Nutritionniste
     */
    ...
    /**
     * PUT /api/nutritionniste/{id}
     * Met à jour une entité Nutritionniste existante
     */
    ...
    /**
     * PATCH /api/nutritionniste/{id}
     * Mise à jour partielle d'une entité Nutritionniste
     */
    ...
    /**
     * DELETE /api/nutritionniste/{id}
     * Supprime une entité Nutritionniste
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Nutritionniste supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Nutritionniste en tableau associatif
     */
    private function serializeEntity(Nutritionniste $entity): array
    {
     ...
     */
    private function hydrateEntity(Nutritionniste $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
