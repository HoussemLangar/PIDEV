...
#[Route('/api/contenu', name: 'contenu_')]
class ContenuController extends AbstractController
{
    public function __construct(
        private readonly ContenuRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/contenu
     * Liste toutes les entités Contenu
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Contenu $entity) => $this->serializeEntity($entity), $entities);
    ...
    /**
     * GET /api/contenu/{id}
     * Retourne une entité Contenu par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Contenu non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/contenu
     * Crée une nouvelle entité Contenu
     */
    ...
    /**
     * PUT /api/contenu/{id}
     * Met à jour une entité Contenu existante
     */
    ...
    /**
     * PATCH /api/contenu/{id}
     * Mise à jour partielle d'une entité Contenu
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Contenu supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Contenu en tableau associatif
     */
    private function serializeEntity(Contenu $entity): array
    {
     ...
     */
    private function hydrateEntity(Contenu $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
