...
#[Route('/api/coach-sportif', name: 'coach-sportif_')]
class CoachSportifController extends AbstractController
{
    public function __construct(
        private readonly CoachSportifRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/coach-sportif
     * Liste toutes les entités CoachSportif
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(CoachSportif $entity) => $this->serializeEntity($entity), $entities);

        return new JsonResponse($data);
    }

    /**
     * GET /api/coach-sportif/{id}
     * Retourne une entité CoachSportif par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'CoachSportif non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/coach-sportif
     * Crée une nouvelle entité CoachSportif
     */
    ...
    /**
     * PUT /api/coach-sportif/{id}
     * Met à jour une entité CoachSportif existante
     */
    ...
    /**
     * PATCH /api/coach-sportif/{id}
     * Mise à jour partielle d'une entité CoachSportif
     */
    ...
    /**
     * DELETE /api/coach-sportif/{id}
     * Supprime une entité CoachSportif
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'CoachSportif supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité CoachSportif en tableau associatif
     */
    private function serializeEntity(CoachSportif $entity): array
    {
     ...
     */
    private function hydrateEntity(CoachSportif $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
