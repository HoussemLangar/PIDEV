...
#[Route('/api/medecin', name: 'medecin_')]
class MedecinController extends AbstractController
{
    public function __construct(
        private readonly MedecinRepository $repository,
        private readonly EntityManagerInterface $entityManager,
    ) {}

    /**
     * GET /api/medecin
     * Liste toutes les entités Medecin
     */
    ...
    public function index(): JsonResponse
    {
        ...
        $data = array_map(fn(Medecin $entity) => $this->serializeEntity($entity), $entities);
    ...
    /**
     * GET /api/medecin/{id}
     * Retourne une entité Medecin par ID
     */
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if (!$entity) {
            return new JsonResponse(['error' => 'Medecin non trouvée avec l\'ID ' . $id], Response::HTTP_NOT_FOUND);
        }
    ...
    /**
     * POST /api/medecin
     * Crée une nouvelle entité Medecin
     */
    ...
    /**
     * PUT /api/medecin/{id}
     * Met à jour une entité Medecin existante
     */
    ...
    /**
     * PATCH /api/medecin/{id}
     * Mise à jour partielle d'une entité Medecin
     */
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        return new JsonResponse(['message' => 'Medecin supprimée avec succès'], Response::HTTP_OK);
    }

    // ─── Serialisation ──────────────────────────────────────────────────────

    /**
     * Sérialise une entité Medecin en tableau associatif
     */
    private function serializeEntity(Medecin $entity): array
    {
     ...
     */
    private function hydrateEntity(Medecin $entity, array $data, bool $partiel = false): void
    {
        $reflection = new \ReflectionClass($entity);
