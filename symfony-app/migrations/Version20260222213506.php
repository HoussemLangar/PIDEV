 ...
 */
final class Version20260222213506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE google_fit_accounts CHANGE token_expiration token_expiration DATETIME DEFAULT NULL, CHANGE last_sync_at last_sync_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE google_fit_accounts RENAME INDEX uniq_2e7f8b6fa76ed395 TO UNIQ_ABCBC1DBA76ED395');
        $this->addSql('ALTER TABLE medicaments ADD image_name VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE pharmacies ADD image_name VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reservations_medicaments CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE reservations_medicaments RENAME INDEX idx_reservations_patient TO IDX_C8F0BB396B899279');
        $this->addSql('ALTER TABLE reservations_medicaments RENAME INDEX idx_reservations_pharmacie TO IDX_C8F0BB39BC6D351B');
        $this->addSql('ALTER TABLE reservations_medicaments RENAME INDEX idx_reservations_medicament TO IDX_C8F0BB39AB0D61F7');
        $this->addSql('ALTER TABLE reservations_medicaments RENAME INDEX idx_reservations_stock TO IDX_C8F0BB39DCD6110');
        $this->addSql('ALTER TABLE sante_quotidienne CHANGE source_donnees source_donnees VARCHAR(20) NOT NULL');
        $this->addSql('ALTER TABLE shared_documents CHANGE uploaded_at uploaded_at DATETIME NOT NULL, CHANGE document_type document_type VARCHAR(50) NOT NULL, CHANGE is_public is_public TINYINT(1) DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE google_fit_accounts CHANGE token_expiration token_expiration DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE last_sync_at last_sync_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE google_fit_accounts RENAME INDEX uniq_abcbc1dba76ed395 TO UNIQ_2E7F8B6FA76ED395');
        $this->addSql('ALTER TABLE medicaments DROP image_name');
        ...
        $this->addSql('ALTER TABLE pharmacies DROP image_name');
        ...
        $this->addSql('ALTER TABLE reservations_medicaments CHANGE created_at created_at DATETIME NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE reservations_medicaments RENAME INDEX idx_c8f0bb396b899279 TO IDX_RESERVATIONS_PATIENT');
        $this->addSql('ALTER TABLE reservations_medicaments RENAME INDEX idx_c8f0bb39bc6d351b TO IDX_RESERVATIONS_PHARMACIE');
        $this->addSql('ALTER TABLE reservations_medicaments RENAME INDEX idx_c8f0bb39ab0d61f7 TO IDX_RESERVATIONS_MEDICAMENT');
        $this->addSql('ALTER TABLE reservations_medicaments RENAME INDEX idx_c8f0bb39dcd6110 TO IDX_RESERVATIONS_STOCK');
        $this->addSql('ALTER TABLE sante_quotidienne CHANGE source_donnees source_donnees VARCHAR(20) DEFAULT \'manuel\' NOT NULL');
        $this->addSql('ALTER TABLE shared_documents CHANGE uploaded_at uploaded_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE document_type document_type VARCHAR(50) DEFAULT \'other\' NOT NULL, CHANGE is_public is_public TINYINT(1) DEFAULT 0');
