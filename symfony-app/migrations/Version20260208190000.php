...
final class Version20260208190000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sante_quotidienne ADD pas INT DEFAULT NULL, ADD calories DOUBLE PRECISION DEFAULT NULL, ADD duree_activite_minutes INT DEFAULT NULL, ADD source_donnees VARCHAR(20) NOT NULL DEFAULT \'manuel\'');
    }
